...
const I18n = (() => {
  ...
  const STRINGS = {
    pt: {
      ...
      'comm.pageLabel': 'Página relacionada (opcional)', 'comm.pagePh': '/item/sibear',
      'comm.send': 'Enviar',
    ...
    en: {
      ...
      'comm.pageLabel': 'Related page (optional)', 'comm.pagePh': '/item/sibear',
      'comm.send': 'Send',
    ...
    ru: {
      ...
      'comm.pageLabel': 'Связанная страница (необязательно)', 'comm.pagePh': '/item/sibear',
      'comm.send': 'Отправить',
    ...
    zh: {
      ...
      'comm.pageLabel': '相关页面（可选）', 'comm.pagePh': '/item/sibear',
      'comm.send': '发送',
