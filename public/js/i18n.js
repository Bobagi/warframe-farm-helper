...
const I18n = (() => {
  ...
  const STRINGS = {
    pt: {
      ...
      'farm.lead': 'Armas e warframes prime cujas peças estão em relíquias disponíveis dos tiers com fissura ativa. Filtre pelo tier da relíquia que você tem.',
    ...
    en: {
      ...
      'farm.lead': 'Prime weapons and warframes whose parts are in available relics of the tiers with an active fissure. Filter by the relic tier you have.',
