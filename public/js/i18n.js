...
const I18n = (() => {
  ...
  const STRINGS = {
    pt: {
      ...
      'title.community': 'Comunidade · sugestões e pedidos · Warframe Farm Helper',
      'nav.search': 'Buscar', 'nav.fissures': 'Fissuras', 'nav.nightwave': 'Nightwave', 'nav.faq': 'FAQ',
      'nav.community': 'Comunidade',
      'comm.h1': 'Comunidade',
      'comm.lead': 'Peça um guia, sugira melhorias, aponte uma falha ou só deixe um comentário. Sem cadastro, Tenno.',
      'comm.formTitle': 'Deixar uma mensagem',
      'comm.kindLabel': 'Tipo',
      'comm.kind.suggestion': 'Sugestão', 'comm.kind.guide': 'Pedido de guia',
      'comm.kind.bug': 'Falha no site', 'comm.kind.comment': 'Comentário',
      'comm.nickLabel': 'Apelido (opcional)', 'comm.nickPh': 'Tenno',
      'comm.msgLabel': 'Mensagem',
      'comm.msgPh': 'Ex.: façam um guia de arcanos… / faltou o preço na página X… / achei um erro em…',
      'comm.pageLabel': 'Página relacionada (opcional)', 'comm.pagePh': 'cole aqui o link da página',
      'comm.cta': 'Algo errado ou faltando nesta página? Conte no mural',
      'comm.send': 'Enviar',
      'comm.ok': 'Recebido! Sua mensagem já está no mural.',
      'comm.note': 'As mensagens são públicas e passam por moderação - conteúdo ofensivo ou spam é removido.',
      'comm.wallTitle': 'Mural', 'comm.count': '{n} mensagens', 'comm.countOne': '1 mensagem',
      'comm.empty': 'Ainda não há mensagens por aqui. Seja o primeiro!',
      'comm.more': 'Carregar mais antigas',
      'comm.reply': 'Resposta do site', 'comm.anon': 'Tenno',
      'comm.loadErr': 'Não deu para carregar o mural. Recarregue a página.',
      'comm.errShort': 'Mensagem curta demais - escreva pelo menos 5 caracteres.',
      'comm.errLong': 'Mensagem longa demais (máx. 1000 caracteres).',
      'comm.errRate': 'Limite de mensagens de hoje atingido - tente de novo amanhã.',
      'comm.errDup': 'Você já enviou essa mesma mensagem hoje.',
      'comm.errGeneric': 'Não deu para enviar agora. Tente de novo em instantes.',
      ...
      'ws.stale': 'A fonte de dados (warframestat.us) está atrasada. Os dados abaixo refletem o estado do jogo por volta de {when} - pode ter mudado desde então.',
      ...
      'baro.none': 'Sem dados do Void Trader agora.',
      ...
      'e404.home': 'Voltar ao início', 'e404.wall': 'Pedir ajuda no mural',
    ...
    en: {
      ...
      'title.item': 'Item · Warframe Farm Helper',
      'title.e404': '404 · Warframe Farm Helper',
      'title.community': 'Community · suggestions & requests · Warframe Farm Helper',
      'nav.search': 'Search', 'nav.fissures': 'Fissures', 'nav.nightwave': 'Nightwave', 'nav.faq': 'FAQ',
      'nav.community': 'Community',
      'comm.h1': 'Community',
      'comm.lead': 'Ask for a guide, suggest improvements, report an issue or just leave a comment. No sign-up, Tenno.',
      'comm.formTitle': 'Leave a message',
      'comm.kindLabel': 'Type',
      'comm.kind.suggestion': 'Suggestion', 'comm.kind.guide': 'Guide request',
      'comm.kind.bug': 'Site issue', 'comm.kind.comment': 'Comment',
      'comm.nickLabel': 'Nickname (optional)', 'comm.nickPh': 'Tenno',
      'comm.msgLabel': 'Message',
      'comm.msgPh': 'E.g.: make an arcane guide… / page X is missing the price… / I found an error in…',
      'comm.pageLabel': 'Related page (optional)', 'comm.pagePh': 'paste the page link here',
      'comm.cta': 'Something wrong or missing on this page? Tell us on the wall',
      'comm.send': 'Send',
      'comm.ok': 'Got it! Your message is on the wall.',
      'comm.note': 'Messages are public and moderated - offensive content and spam get removed.',
      'comm.wallTitle': 'Wall', 'comm.count': '{n} messages', 'comm.countOne': '1 message',
      'comm.empty': 'No messages yet. Be the first!',
      'comm.more': 'Load older',
      'comm.reply': 'Site reply', 'comm.anon': 'Tenno',
      'comm.loadErr': 'Could not load the wall. Reload the page.',
      'comm.errShort': 'Message too short - write at least 5 characters.',
      'comm.errLong': 'Message too long (max 1000 characters).',
      'comm.errRate': 'Daily message limit reached - try again tomorrow.',
      'comm.errDup': 'You already sent this exact message today.',
      'comm.errGeneric': 'Could not send right now. Try again in a moment.',
      ...
      'ws.stale': 'The data source (warframestat.us) is running behind. The data below reflects the game state around {when} - it may have changed since.',
      ...
      'baro.none': 'No Void Trader data right now.',
      ...
      'e404.home': 'Back to home', 'e404.wall': 'Ask on the community wall',
    ...
    es: {
      ...
      'title.e404': '404 · Warframe Farm Helper',
      'title.community': 'Comunidad · sugerencias y pedidos · Warframe Farm Helper',
      'nav.search': 'Buscar', 'nav.fissures': 'Fisuras', 'nav.nightwave': 'Nightwave', 'nav.faq': 'FAQ',
      'nav.community': 'Comunidad',
      'comm.h1': 'Comunidad',
      'comm.lead': 'Pide una guía, sugiere mejoras, reporta un fallo o simplemente deja un comentario. Sin registro, Tenno.',
      'comm.formTitle': 'Dejar un mensaje',
      'comm.kindLabel': 'Tipo',
      'comm.kind.suggestion': 'Sugerencia', 'comm.kind.guide': 'Pedido de guía',
      'comm.kind.bug': 'Fallo del sitio', 'comm.kind.comment': 'Comentario',
      'comm.nickLabel': 'Apodo (opcional)', 'comm.nickPh': 'Tenno',
      'comm.msgLabel': 'Mensaje',
      'comm.msgPh': 'Ej.: hagan una guía de arcanos… / falta el precio en la página X… / encontré un error en…',
      'comm.pageLabel': 'Página relacionada (opcional)', 'comm.pagePh': 'pega aquí el enlace de la página',
      'comm.cta': '¿Algo mal o faltando en esta página? Cuéntalo en el muro',
      'comm.send': 'Enviar',
      'comm.ok': '¡Recibido! Tu mensaje ya está en el muro.',
      'comm.note': 'Los mensajes son públicos y moderados: el contenido ofensivo o spam se elimina.',
      'comm.wallTitle': 'Muro', 'comm.count': '{n} mensajes', 'comm.countOne': '1 mensaje',
      'comm.empty': 'Aún no hay mensajes. ¡Sé el primero!',
      'comm.more': 'Cargar más antiguos',
      'comm.reply': 'Respuesta del sitio', 'comm.anon': 'Tenno',
      'comm.loadErr': 'No se pudo cargar el muro. Recarga la página.',
      'comm.errShort': 'Mensaje demasiado corto: escribe al menos 5 caracteres.',
      'comm.errLong': 'Mensaje demasiado largo (máx. 1000 caracteres).',
      'comm.errRate': 'Límite diario de mensajes alcanzado: inténtalo mañana.',
      'comm.errDup': 'Ya enviaste este mismo mensaje hoy.',
      'comm.errGeneric': 'No se pudo enviar ahora. Inténtalo de nuevo en un momento.',
      ...
      'ws.stale': 'La fuente de datos (warframestat.us) está atrasada. Los datos de abajo reflejan el estado del juego alrededor de {when} - puede haber cambiado desde entonces.',
      'cookies.aria': 'Aviso de cookies',
      ...
      'baro.title': "Baro Ki'Teer", 'baro.loading': 'Consultando…',
      'baro.none': 'Sin datos del Void Trader ahora.',
      ...
      'e404.home': 'Volver al inicio', 'e404.wall': 'Pedir ayuda en el muro',
    ...
    ru: {
      ...
      'title.e404': '404 · Warframe Farm Helper',
      'title.community': 'Сообщество · предложения и запросы · Warframe Farm Helper',
      'nav.search': 'Поиск', 'nav.fissures': 'Разломы', 'nav.nightwave': 'Nightwave', 'nav.faq': 'ЧаВо',
      'nav.community': 'Сообщество',
      'comm.h1': 'Сообщество',
      'comm.lead': 'Попросите гайд, предложите улучшение, сообщите об ошибке или просто оставьте комментарий. Без регистрации, Тэнно.',
      'comm.formTitle': 'Оставить сообщение',
      'comm.kindLabel': 'Тип',
      'comm.kind.suggestion': 'Предложение', 'comm.kind.guide': 'Запрос гайда',
      'comm.kind.bug': 'Ошибка сайта', 'comm.kind.comment': 'Комментарий',
      'comm.nickLabel': 'Ник (необязательно)', 'comm.nickPh': 'Tenno',
      'comm.msgLabel': 'Сообщение',
      'comm.msgPh': 'Напр.: сделайте гайд по арканам… / на странице X нет цены… / нашёл ошибку в…',
      'comm.pageLabel': 'Связанная страница (необязательно)', 'comm.pagePh': 'вставьте сюда ссылку на страницу',
      'comm.cta': 'Что-то не так или чего-то не хватает на этой странице? Напишите на стене',
      'comm.send': 'Отправить',
      'comm.ok': 'Принято! Ваше сообщение уже на стене.',
      'comm.note': 'Сообщения публичны и модерируются: оскорбления и спам удаляются.',
      'comm.wallTitle': 'Стена', 'comm.count': '{n} сообщений', 'comm.countOne': '1 сообщение',
      'comm.empty': 'Пока нет сообщений. Будьте первым!',
      'comm.more': 'Показать более старые',
      'comm.reply': 'Ответ сайта', 'comm.anon': 'Tenno',
      'comm.loadErr': 'Не удалось загрузить стену. Перезагрузите страницу.',
      'comm.errShort': 'Сообщение слишком короткое - минимум 5 символов.',
      'comm.errLong': 'Сообщение слишком длинное (макс. 1000 символов).',
      'comm.errRate': 'Дневной лимит сообщений исчерпан - попробуйте завтра.',
      'comm.errDup': 'Вы уже отправили точно такое же сообщение сегодня.',
      'comm.errGeneric': 'Не удалось отправить. Попробуйте ещё раз через минуту.',
      ...
      'ws.stale': 'Источник данных (warframestat.us) отстаёт. Данные ниже отражают состояние игры примерно на {when} - с тех пор всё могло измениться.',
      ...
      'cookies.manage': 'Управление cookies',
      ...
      'baro.none': 'Данных о Void Trader сейчас нет.',
      ...
      'e404.home': 'На главную', 'e404.wall': 'Попросить помощи на стене',
    ...
    zh: {
      ...
      'title.community': '社区 · 建议与请求 · Warframe Farm Helper',
      'nav.search': '搜索',
      'nav.fissures': '裂缝',
      'nav.nightwave': '午夜电波',
      'nav.faq': '常见问题',
      'nav.community': '社区',
      'comm.h1': '社区',
      'comm.lead': '想要新攻略、有改进建议、发现网站问题，或者只想留个言？无需注册，Tenno。',
      'comm.formTitle': '留言',
      'comm.kindLabel': '类型',
      'comm.kind.suggestion': '建议', 'comm.kind.guide': '攻略请求',
      'comm.kind.bug': '网站问题', 'comm.kind.comment': '留言',
      'comm.nickLabel': '昵称（可选）', 'comm.nickPh': 'Tenno',
      'comm.msgLabel': '内容',
      'comm.msgPh': '例如：做一篇赋能攻略… / X 页面缺少价格… / 我发现一个错误…',
      'comm.pageLabel': '相关页面（可选）', 'comm.pagePh': '把页面链接粘贴到这里',
      'comm.cta': '这个页面有错误或缺少内容？到留言墙告诉我们',
      'comm.send': '发送',
      'comm.ok': '已收到！你的留言已经在留言墙上。',
      'comm.note': '留言是公开的，并会被审核 - 冒犯性内容和垃圾信息会被删除。',
      'comm.wallTitle': '留言墙', 'comm.count': '{n} 条留言', 'comm.countOne': '1 条留言',
      'comm.empty': '还没有留言，来做第一个吧！',
      'comm.more': '加载更早的',
      'comm.reply': '站方回复', 'comm.anon': 'Tenno',
      'comm.loadErr': '留言墙加载失败，请刷新页面。',
      'comm.errShort': '内容太短 - 至少 5 个字符。',
      'comm.errLong': '内容太长（最多 1000 个字符）。',
      'comm.errRate': '今天的留言次数已用完 - 明天再试。',
      'comm.errDup': '你今天已经发过一模一样的留言了。',
      'comm.errGeneric': '暂时无法发送，请稍后再试。',
      ...
      'e404.home': '回到首页', 'e404.wall': '到留言墙求助',
      'cyc.aria': '星球昼夜循环',
      'cyc.cetus': '希图斯',
      'cyc.vallis': '奥布山谷',
      'cyc.cambion': '火卫二',
