---
title: Completar uma Sortie
keywords: sortie, sortida, missao diaria, riven
match: [["sortie"]]
order: 34
---

**Sortie** é a sequência diária de 3 missões nível 50-100 com modificadores (reseta todo dia).

## Requisitos

- Ter completado a quest **The War Within**.
- Acesso: Navegação → aba de Sorties (ícone de medalha), ou pelo painel de alertas.

## Como fechar sem drama
...
Rivens, Kuva, potatoes, Forma... uma roleta diária que vale os 20-30 minutos. O ato conta ao completar as **3 missões**.
