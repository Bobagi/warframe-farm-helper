---
title: Dá pra pôr tudo no Helminth?
keywords: helminth, subsumir, o que pode subsumir, armas helminth, companion helminth
order: 12
---
...
- **Subsumir um warframe**: consome o frame e desbloqueia **1 habilidade pré-determinada** dele, que você pode injetar num slot de habilidade de outros frames (substituindo a habilidade daquele slot, por configuração).
- **Habilidades próprias do Helminth**: ele também oferece habilidades exclusivas (Empower, Infested Mobility etc.) sem precisar sacrificar frame nenhum.
- **Invigorations** (após evoluir o Helminth): buffs temporários semanais para frames.
